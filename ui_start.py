...
class Start:
    def __init__ (self,screen,sounds):
        ...
        self.start_options = StartOptions(name="options",master_surface = self.screen,x=100,y=200,w=600,h=300,background_color=None,border_color=None,active=False,sounds=sounds)
